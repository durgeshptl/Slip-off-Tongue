// Global flag - true = new model (default), false = classic/old model
...
async function analyze() {
  ...
  try {
    const url = useNewModel ? "/predict_new" : "/predict";
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  statusText.innerHTML = 'Using <span style="color:#7b61ff;">New Model (XLMR)</span> — Better accuracy';
  ...
  switchInput.addEventListener("change", () => {
    ...
    if (useNewModel) {
      ...
      statusText.innerHTML = 'Using <span style="color:#888;">Classic Model</span> — Original version';
    }
  });
});
